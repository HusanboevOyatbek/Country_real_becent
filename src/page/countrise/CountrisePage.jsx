...
const CountrisePage = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      if (isEditing && currentRecord) {
        await axios.put(`https://v1.turbotravel.uz/api/countries/${currentRecord.id}`, values, {
          headers: {
        ...
        await axios.post(`https://v1.turbotravel.uz/api/countries`, values, {
          headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${token}`
          }
  ...
  return (<>
    ...
    <Table columns={columns} loading={loading} dataSource={countries} />
  </>)
};
export default CountrisePage;